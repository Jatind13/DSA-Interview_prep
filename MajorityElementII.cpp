...
{
    int count1 = 0, count2 = 0;  //approach is simple just use Moores voting algo .
    int first=INT_MAX    , second=INT_MAX    ; //fro n/3 there can be 2 majority elements .
                                               //so to maintain this we took integers.
    for (int i = 0; i < n; i++) {
